...
class PyObjHandle(object):
	...
	def skill_level_get(self, obj2, skillId):
		"""Gets specific skill score. npc.skill_level_get(PyObjHandle: obj2, int[skill_appraise...]: skillId) -> int"""
		return

	def skill_level_get(self, skillId):
		"""Gets specific skill score. npc.skill_level_get(int[skill_appraise...]: skillId) -> int"""
		return
